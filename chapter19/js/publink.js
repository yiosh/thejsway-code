...
document.getElementById("linkForm").addEventListener("submit", e => {
  ...
  if (author.length === 0 || title.length === 0 || url.length === 0) {
    ...
    document.getElementById("placeholder").insertAdjacentHTML("afterEnd", `<div id="link" class="link"><h4 class="linkHeadline"><a class="linkTitle" href="${url}">${title}</a><span class="linkUrl">${url}</span></h4><span class="linkAuthor">Submited by ${author}</span></div>`);
